<template>
  <div class="row border-1 p-2">
    ...
    <div class="col-4">
      <router-link :to="{ name: 'ProductShow', params: { id: product.id } }" class="btn btn-success"
        title="View Product">
        <i class="fa fa-eye"></i>
      </router-link>
      <router-link :to="{ name: 'ProductEdit', params: { id: product.id } }" class="btn btn-primary ml-2"
        title="Edit Product">
        <i class="fa fa-pencil"></i>
      </router-link>
      <router-link :to="{ name: 'ProductUpload', params: { id: product.id } }" class="btn btn-warning ml-2"
